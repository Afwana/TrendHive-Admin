...
export const fetchAdminInfo = createAsyncThunk(
  ...
  async () => {
    const result = await axios.get(`${baseUrl}/api/admin/footer/get/info`);
...
export const fetchAllMessages = createAsyncThunk(
  ...
  async () => {
    const result = await axios.get(`${baseUrl}/api/admin/footer/get`);
...
export const deleteMessage = createAsyncThunk(
  ...
  async (id) => {
    const result = await axios.delete(
      `${baseUrl}/api/admin/footer/delete/${id}`
    );
